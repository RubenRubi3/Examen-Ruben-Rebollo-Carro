...
public class Principal {
	...
	public static void main(String[] args) {
		...
		System.out.println("codigo: " + alumno.codigo + " " + alumno.nombre + " Español final: " + promediarEs()
				+ " sexo: " + alumno.sexo);
		System.out.println("codigo: " + alumno.codigo + " " + alumno.nombre + " Ingles final: " + promediarIn()
				+ " sexo: " + alumno.sexo);
